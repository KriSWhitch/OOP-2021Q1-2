...
namespace lab6n7
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            // Заполняем меню выбора темы
            List<string> styles = new List<string> { "StandartTheme","LightTheme", "DarkTheme" };
            ComboBoxThemes.SelectionChanged += ThemeChange;
            ComboBoxThemes.ItemsSource = styles;
            ComboBoxThemes.SelectedItem = "StandartTheme";
        }

        private void ThemeChange(object sender, SelectionChangedEventArgs e)
        {
            string style = ComboBoxThemes.SelectedItem as string;
