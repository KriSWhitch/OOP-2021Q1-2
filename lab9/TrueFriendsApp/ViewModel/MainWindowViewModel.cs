...
namespace TrueFriendsApp.ViewModel
{
    class MainWindowViewModel : ViewModelBase
    {
        ...
        private RelayCommand _Loadlab9Command;
        public RelayCommand Loadlab9Command
        {
            get
            {
                return _Loadlab9Command = _Loadlab9Command ??
                  new RelayCommand(OnLoadlab9Page, CanLoadlab9Page);
            }
        }
        private bool CanLoadlab9Page()
        {
            return true;
        }
        private void OnLoadlab9Page()
        {
            CodeBehind.LoadView(ViewType.lab9);
        }
